...
function buildBibliometricRScript(analysis: BibliometricAnalysis): BibliometricRScript {
  ...
  const rCode = [
    ...
    '}',
    '',
    'theme_scholar <- theme_bw(base_size = 12) +',
    '  theme(',
    ...
    '    axis.text = element_text(colour = "#16231f", family = font_family),',
    '    axis.title = element_text(colour = "#16231f", family = font_family),',
    '    plot.title = element_text(face = "bold", colour = "#0f3d31", family = font_family, size = 13),',
    ...
    '  theme(',
    '    plot.title = element_text(face = "bold", colour = "#0f3d31", family = font_family, size = 13, hjust = 0),',
    '    legend.position = "right",',
    ...
    '  ggplot() +',
    '    annotate("text", x = 0, y = 0, label = message, family = font_family, size = 4, colour = "#5f6f68") +',
    ...
    '                             family = font_family, size = 3.05, colour = "#16231f",',
