...
3. Research boundary lock: region, crop/system, management measures, core indicators, mechanism variables, time/space scale, treatment/control objects, what can be discussed, and what should be excluded or weakened.
...
6. Innovation check: do not treat a new region, more references, generic framework, or "first review" as innovation unless the evidence supports it. Retain only innovation from new question, evidence grading, mechanism integration, regional framework, indicator system, scenario classification, controversy synthesis, gap identification, or decision framework.
7. Mechanism-chain check: connect management measure -> soil/biological/environmental process -> indicator change -> response -> yield/efficiency/environmental trade-off. Mark weak mechanisms as possible explanations, not proven facts.
...
9. High-risk detection: topic larger than evidence, conclusion stronger than evidence, background larger than problem, vague mechanism, literature piling, discussion repeating results, conclusion repeating abstract, empty innovation, unclear boundary, mixed region/crop/system evidence, model/lab evidence written as field conclusion, adjacent evidence treated as direct evidence, possible mechanism written as proven mechanism, unsupported yield/efficiency claims, many citations without answering a scientific question.
