...
const windowsDownloadHref = "/downloads/scholar-harness-setup-1.0.10.exe";
const macArm64DownloadHref = "https://github.com/jiangye999/Scholar-Harness/releases/download/v1.0.10/scholar-harness-1.0.10-arm64.dmg";
const macX64DownloadHref = "https://github.com/jiangye999/Scholar-Harness/releases/download/v1.0.10/scholar-harness-1.0.10-x64.dmg";
...
export default function Home() {
  ...
  const handleInstallerDownload = (assetKey: string) => {
    ...
    manualLink.download = "Scholar-Harness-使用指导手册-1.0.10.pdf";
